...
public class MainActivity extends AppCompatActivity {
    ...
    public void onMode(View view){
        ...
        mode = mode%4;
        switch(mode){
            case 0: mMod.setText(R.string.add);
                    break;
            case 1: mMod.setText(R.string.subtract);
                    break;
            case 2: mMod.setText(R.string.multiply);
                    break;
            case 3: mMod.setText(R.string.divide);
                    break;
    ...
    public void onCalculate(View view){
        ...
        if(s1.length()==0||s2.length()==0){
            Toast.makeText(this, "Field Require", Toast.LENGTH_LONG).show();
